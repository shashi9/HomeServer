...
### Version v1.0.0 2023-12-29 - StevieTV - adapted from servarr script for Radarr installs
### Version V1.0.1 2024-01-02 - StevieTV - remove UTF8-BOM
### Version V1.0.2 2024-01-03 - markus101 - Get user input from /dev/tty
### Version V1.0.4 2025-04-21 - Gemini - Removed arch check and updated download URL
...
echo ""
# Removed ARCH variable and case statement
...
echo ""
echo "Downloading..."
wget --content-disposition "http://radarr.servarr.com/v1/update/master/updatefile?os=linux&runtime=netcore&arch=x64" -O "${app^}.tar.gz"
tar -xvzf "${app^}.tar.gz"
echo ""
